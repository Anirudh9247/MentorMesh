...
class UserRegister(BaseModel):
    ...
    role: Literal["student", "mentor"] = Field(..., description="Must be either 'student' or 'mentor'")
...
class TokenData(BaseModel):
    ...
    role: Optional[Literal["student", "mentor"]] = None
...
# ==========================================
# REVIEW SCHEMAS (Moved up for reference)
# ==========================================
